...
function getStrLength(str) {  
    ...
    alert(len + "_" + str.length + "_" + cArr.length);
    */
    return str.length;
}  
...
(function(factory) {
    ...
    var RULES = {
        ...
        minNum: function(value, length, errorMsg) {
            //大于
            if (parseInt(value) < length) {
                return errorMsg;
            }
        },
        maxNum: function(value, length, errorMsg) {
            //小于
            if (parseInt(value) > length) {
                return errorMsg;
            }
        },
        noZero: function(value, length, errorMsg) {
            if (parseInt(value) == length) {
                return errorMsg;
            }
        },
        ...
        LengthDY: function(value, length, errorMsg) {
            //长度等于
        ...
        betweenNum: function(value, range, errorMsg) {
            //大于小于
        ...
        onNoZh: function(value, errorMsg) {
            //非中文
            if (!/^\w+$/.test(value)) {
                return errorMsg;
            }
